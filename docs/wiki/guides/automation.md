...
p-hermes는 **'Registry $\rightarrow$ Wrapper $\rightarrow$ Runner'**라는 3계층 구조를 통해 이러한 문제를 해결하고, 사용자가 채팅만으로 자동화 설정을 자유롭게 변경할 수 있게 합니다.
...
- **예**: `schedule: "0 9 * * 1"` $\rightarrow$ 매주 월요일 오전 9시 정각 실행.
