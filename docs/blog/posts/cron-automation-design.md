...
**Decoupled Execution 이점**
- **재사용성**: 하나의 Job 정의, 여러 스케줄
- **유연성**: 스케줄 독립적 변경
- **운영 단순화**: 정의/실행 분리
- **확장성**: 새로운 스케줄 추가 용이
- **Job 정의 재사용**: YAML 기반
- **Decoupled Execution 자동화**
- **Decoupled Execution 정책**
- **Decoupled Execution 확장성**
- **Decoupled Execution 모니터링**
- **Decoupled Execution 검증**

**Decoupled Execution 규칙**
- Job 정의 YAML
- 스케줄 분리
- 실행 로그 기록
- Job 정의 재사용
...
- 재시도 로그
- 재시도 자동화
- Automated Recovery 정책
- Automated Recovery 자동화
- Automated Recovery 검증
- Automated Recovery 확장성
- Automated Recovery 모니터링
- Automated Recovery 추적
...
- **유연성**: 복잡한 작업 처리 가능
- **LLM Model**: 모델 선택 가능 (glm-5.2, Qwen3.6 등)
...
**Event-Driven Job 이점**
- **실시간 처리**: 이벤트 발생 즉시 반응
- **Decoupling**: 이벤트 소스/Job 분리
- **확장성**: 새로운 이벤트 Listener 추가 용이
...
## 📚 관련 문서
- [Cron System Wiki](../wiki/guides/cron-system.md)
